...
module.exports = async (client, interaction) => {
    if (interaction.isChatInputCommand()) {
        ...
        if (!require("../../utils/server-validator").isServerAllowed(interaction.guild.id)) {
            return interaction.reply({ content: "❌ Este bot solo funciona en servidores autorizados.", ephemeral: true });
        }
        ...
        // Validar que el servidor esté autorizado para interacciones
        if (!require("../../utils/server-validator").isServerAllowed(interaction.guild.id)) {
            return interaction.reply({ content: "❌ Este bot solo funciona en servidores autorizados.", ephemeral: true });
        }
